...
New-AzureADUser -DisplayName "Noreen Riggs" -UserPrincipalName Noreen@M365x45120677.onmicrosoft.com -AccountEnabled $true -PasswordProfile $PasswordProfile -MailNickName Noreen

Get-AzureAduser -All $true
Get-AzureADUser -ObjectId Noreen@M365x45120677.onmicrosoft.com

#Adduser to a Role
$user = Get-AzureADUser -ObjectID Noreen@M365x45120677.onmicrosoft.com
$role = Get-AzureADDirectoryRole | Where { $_.displayName -eq 'Global Administrator' }
Add-AzureADDirectoryRoleMember -ObjectId $role.ObjectId -RefObjectId $user.ObjectID
    
#Add user to a role with MSOL
Connect-MsolService
Add-MsolRoleMember -RoleMemberEmailAddress Noreen@M365x45120677.onmicrosoft.com -RoleName 'User Administrator'

#create user and assign license
New-AzureADUser -DisplayName "Allan Yoo" -UserPrincipalName Allan@M365x45120677.onmicrosoft.com -AccountEnabled $true -PasswordProfile $PasswordProfile -MailNickName Allan
#remember location property must be set
Set-AzureADUser -ObjectId Allan@M365x45120677.onmicrosoft.com -UsageLocation US
...
Set-AzureADUserLicense -ObjectId Allan@M365x45120677.onmicrosoft.com -AssignedLicenses $LicensesToAssign


#Create user with MSonline
New-MsolUser -DisplayName "Sammy Buzikashvilli" -FirstName "Sammy" -LastName "Buzikashvilli" -UserPrincipalName Sammy@M365x45120677.onmicrosoft.com -Password "Pa55w.rd"

Get-msoluser -UserPrincipalName Sammy@M365x45120677.onmicrosoft.com
Get-Msoluser -All
